...
gain = 30
f_zero = 5500
w_zero = f_zero * 2 * np.pi

controller = gain * (s + w_zero) / w_zero
...
#################################################################################
# Convierto Planta por Tustin a una frecuencia mucho mas alta que la de muetreo #
# para que no afecte polos o ceros                                              #                          
#################################################################################
Fsampling = 12000
Fsampling_mult = Fsampling * 10
